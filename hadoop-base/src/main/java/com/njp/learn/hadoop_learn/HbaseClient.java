...
/*      HbaseClient.createTable("apitable", "testcf");
      HbaseClient.putC("apitable", "100001", "testcf", "name", "liyang");
      HbaseClient.putRow("apitable", "100003", "testcf", "name", "leon");
    	HbaseClient.deleteRow("apitable", "100002");
    	HbaseClient.getRow("apitable", "100003");
  ¡¢¡¢  	HbaseClient.deleteTable("apitable");*/
